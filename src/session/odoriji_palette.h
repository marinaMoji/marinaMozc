...
class OdorijiPalette {
 public:
  ...
  // index when committing (Enter or 1-8). Returns true if the key was
  // consumed (caller should Output and return).
  ...
  // set result and *visible = false; if session_default_index non-null set it
  // to id. Return true. Otherwise return false.
